...
import { clearLoginToken } from '~/common/js/localStorage';
...
export const MENU_STRUCTURE = [
  {
    ...
    modifier: 'overview',
    icon: 'overview',
    className: 'mobile-nav__link_overview',
  },
  {
    to: Pages.PAY,
    title: 'Пополнение',
    modifier: 'pay',
    icon: 'plus',
    className: 'mobile-nav__link_pay',
  },
  {
    to: Pages.SERVICES,
    ...
    modifier: 'services',
    icon: 'prices',
    className: 'mobile-nav__link_services',
  },
  {
    to: Pages.ROAMING,
    title: 'Роуминг',
    modifier: 'roaming',
    icon: 'roaming',
    className: 'mobile-nav__link_roaming',
  },
  {
    to: Pages.HISTORY,
    title: 'История',
    modifier: 'history',
    icon: 'history',
    className: 'mobile-nav__link_history',
  },
  {
    to: Pages.SETTINGS,
    title: 'Настройки',
    modifier: 'settings',
    icon: 'settings',
    className: 'mobile-nav__link_settings',
  },
  {
    ...
    icon: 'support',
    className: 'mobile-nav__link_support',
  },
  {
    to: Pages.Exit,
    title: 'Выход',
    modifier: 'exit',
    icon: 'exit',
    className: 'mobile-nav__link_exit',
...
export const Statuses = {
  ...
  TRANSITION_STOPPED_OTHER_PERSONE: 'transition-stopped-other-person',
  SIM_DELIVERY: 'sim-delivery',
  SIM_DELIVERY_TODAY: 'sim-delivery-today',
  TRANSITION_CANCELED: 'transition-canceled',
};
...
export const PROMO_STATUS_NEW = 0
