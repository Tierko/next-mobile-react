...
export const getZonesAction = () => (
  dispatch => ajax('/media/info/roaming-zones.json', dispatch, zonesRequest, zonesRequestFail, zonesRequestSuccess)
);
...
export const getFeaturesAction = () => (
  dispatch => ajax('/media/info/map.geo.json', dispatch, featuresRequest, featuresRequestFail, featuresRequestSuccess)
);
...
export const getRoamingInternetAction = () => (
  dispatch => ajax('/media/info/roaming-internet.json', dispatch, roamingInternetRequest, roamingInternetRequestFail, roamingInternetRequestSuccess)
);
